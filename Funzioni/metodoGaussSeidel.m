...
if k == Nmax % se si è raggiunto il numero massimo di iterazioni consentite
    disp('Il metodo di Gauss-Seidel ha raggiunto il numero massimo di iterazioni consentite.');
end
